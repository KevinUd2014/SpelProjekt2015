...
namespace KillingStory
{
    ...
    public class MasterController : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            ScreenManager.Instance.LoadContetnt(Content);
        ...
        {
            GraphicsDevice.Clear(Color.Black);//¨backgrunden är s´vart

            spriteBatch.Begin();
            ScreenManager.Instance.Draw(spriteBatch);//kör min instans av screen manager som ska hålla koll på alla skärmar!
            spriteBatch.End();
